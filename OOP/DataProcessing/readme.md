...
9. [Thêm phần tử mới - Insert()](#update-9-thêm-phần-tử-mới---insert)
10. [Xóa toàn bộ phần tử - DeleteAll()](#update-10-xóa-toàn-bộ-phần-tử---deleteall)
11. [Xóa (các) phần tử thỏa mãn điều kiện - Delete()](#update-11-xóa-các-phần-tử-thỏa-mãn-điều-kiện---delete)
